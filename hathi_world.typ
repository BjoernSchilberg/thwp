...
#let create-world(
  ...
  let objects = (
    h: (img: image(assets-path + "hathi.svg", width: tile-w * 0.75), size: tile-w * 0.75, offset: 0.25),
    b: (img: image(assets-path + "bananas.svg", width: tile-w * 1), size: tile-w * 1, offset: 0),
    t: (img: image(assets-path + "tree.svg", width: tile-w * 1), size: tile-w * 1, offset: 0),
    r: (img: image(assets-path + "rock.svg", width: tile-w * 1), size: tile-w * 1, offset: 0),
    s: (img: image(assets-path + "squash.svg", width: tile-w * 1), size: tile-w * 1, offset: 0),
    l: (img: image(assets-path + "lion_0.svg", width: tile-w * 1.25), size: tile-w * 1.25, offset: 0),
    c: (img: image(assets-path + "crate.svg", width: tile-w * 1.25), size: tile-w * 1.25, offset: 0),
    C: (img: image(assets-path + "crate_closed.svg", width: tile-w * 1.25), size: tile-w * 1.25, offset: 0),
    f: (img: image(assets-path + "flag.svg", width: tile-w * 1.25), size: tile-w * 1.25, offset: 0),
    F: (img: image(assets-path + "flag_hoisted.svg", width: tile-w * 1.25), size: tile-w * 1.25, offset: 0),
  )
